    ...
    <main className={styles.aboutFullTemplateContainer}>
      ...
      <div className={styles.contentWrapper}>
        ...
        <p>
          ...
          to school to get his Doctor of Pharmacy degree. I have spent the last
          decade working to give back to the people of Harris County. I have
          been successful in my life and in my career, but I recognize I
          ...
          reflect upon their lives and recall a moment in time, where someone
          did something for them and it completely changed the course of their
          lives for the better. Have you ever heard someone say the following
          quote?
          <br />
          <br />
          <blockquote>
          ...
          kids on college and university campuses, targeting students 10-13
          years old to familiarize them with the higher education opportunities
          in the Houston area. It is important for all students to experience
          the wonder and beauty of our local college and university campuses, to
          make space for them to dream.Academia is not the path for everyone,
          but everyone should know the path to academia. It must be an option
          within reach of every child, should they choose to pursue it.
          <br />
          <br />
